...
在 2026 年做飞控选型，最容易踩的坑是把 PX4 和 ArduPilot 当成单纯的“性能对决”。

更实用的判断顺序应该是：

1. **你的机型是什么**：多旋翼、固定翼、垂起、车船，不同平台成熟度差异很大。
2. **团队能力在哪里**：更擅长模块化开发、仿真与研究协作，还是更擅长快速交付、参数调试与任务落地。
3. **地面站和外围生态习惯如何**：现场团队熟悉 Mission Planner / QGroundControl，还是已有自研链路。
4. **后期维护谁来做**：项目不是飞起来就结束，后续升级、培训、排障和日志分析同样重要。

**简化判断：**
- 偏研究、架构化开发、工业协作 → 更适合重点评估 **PX4**
- 偏任务覆盖、成熟交付、多载体适配 → 更适合重点评估 **ArduPilot**
